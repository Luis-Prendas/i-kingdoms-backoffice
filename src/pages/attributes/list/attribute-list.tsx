...
export function AttributeList() {
  ...
  const [rowSelected, setRowSelected] = useState<Attribute | null>(null)
  ...
  const columns: ColumnDef<Attribute>[] = [
    {
      accessorKey: 'attri_name',
      header: 'Atributo',
      footer: info => info.column.id,
    },
    {
      accessorKey: 'up_attri_name',
      header: 'Mayusculas',
      footer: info => info.column.id,
    },
    {
      accessorKey: 'min_attri_name',
      header: 'Abreviatura',
      footer: info => info.column.id,
    },
    {
      accessorKey: 'up_min_attri_name',
      header: 'Abreviatura Mayusculas',
      footer: info => info.column.id,
    },
    {
      header: 'Acciones',
